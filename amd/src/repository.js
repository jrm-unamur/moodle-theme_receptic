...
define(['core/ajax', 'core/notification'], function(Ajax, Notification) {
    ...
    var getEnrolledCoursesByTimeline = function(args) {
        ...
        var request = {
            methodname: 'theme_receptic_get_enrolled_courses_by_timeline_classification',
            args: args
        };
    ...
    var changeCourseVisibility = function(args) {
    ...
    var unenrolMe = function(args) {

        var request = {
            methodname: 'theme_receptic_unenrolme',
            args: args
        };
