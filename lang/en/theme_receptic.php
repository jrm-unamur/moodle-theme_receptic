...
$string['allowremovecoursesfromdisplay'] = 'Remove courses from display';
$string['allowremovecoursesfromdisplay_desc'] = 'Allow users to remove courses from display in their dashboard';
$string['brandbanner'] = 'Brand banner';
$string['brandbanner_desc'] = 'Display brand banner with logo(s) defined below';
$string['brandbannercolor'] = 'Brand banner color';
$string['brandbannercolor_desc'] = 'Base color for brand banner gradient';
$string['brandbannerheading'] = 'Custom banner';
$string['brandcolor'] = 'Brand color';
$string['brandcolor_desc'] = 'The accent colour. If not set, the variable defined in preset file will be used.';
...
$string['favicon_desc'] = 'You can upload here a favicon file in .ico or .png format'.
...
$string['passportwarning'] = 'Passport reminder';
$string['passportwarning_desc'] = 'Display a warning message to students who have not taken the passport yet';
$string['passportwarningmessage'] = 'Passport reminder message';
$string['passportlink'] = '<br/><h4 class="text-center"><a href="course/view.php?id={$a}">Go to passport</a></h4>';
$string['passwordwarning'] = 'Change your password';
$string['passwordwarning_desc'] = 'Display a warning message to students who have not changed their password yet';
$string['passwordwarningmessagestudents'] = 'Password reminder message for students';
$string['passwordwarningmessagestaff'] = 'Password reminder message for staff';
$string['pluginname'] = 'Receptic';
$string['poweredby'] = 'Powered by';
$string['preset'] = 'Theme preset';
$string['presetheading'] = 'Preset';
