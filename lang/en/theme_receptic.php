...
$string['collapsingsections'] = 'Sections collapsing';
$string['collapsingsectionsdesc'] = 'In "Show all sections on one page" layout, activate sections collapsing. This parameter is activated for all courses on a per format basis to keep layout consistency.';
$string['collapsingtopics'] = 'Topics format';
