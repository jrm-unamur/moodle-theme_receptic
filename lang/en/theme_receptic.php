...
$string['enableredballs'] = 'Enable red balls';
...
$string['enableorangeballs'] = 'Enable orange balls';
$string['enableorangeballs_desc'] = 'Display the number of resources and activities with modified content in user dashboard and section names; pin "content-updated activities and resources in course home page';
...
$string['flashbox:edit'] = 'Capability to edit flashboxes';
