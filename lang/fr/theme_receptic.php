...
$string['localcreatecoursepath'] = 'Méthode locale pour la création de cours';
$string['localcreatecoursepath_desc'] = 'Chemin vers un fichier de plugin local qui gère une méthode alternative de création de cours (par exemple si la création de cours est conditionnée à une liste officielle).';
$string['bulkenrolme'] = 'Bouton "M\'inscrire à mes cours"';
$string['bulkenrolme_desc'] = 'Ajouter un bouton pour une inscription en lot d\'un étudiant à ses cours (Nécessite un plugin local spécifique à votre institution).';
$string['bulkenrolmepath'] = 'Méthode locale pour l\'inscription en lot';
$string['bulkenrolmepath_desc'] = 'Chemin vers un fichier de plugin local qui gère l\'inscription en lot d\'un étudiant à ses cours';
