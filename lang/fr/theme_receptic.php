...
$string['enableredballs'] = 'Activer les boules oranges';
$string['enableredballs_desc'] = 'Afficher sur le tableau de bord et à côté du nom des sections le nombre d\'activités/ressources dont le contenu a été modifié et non encore consulté par l\'utilisateur; afficher une boule orange en regard des activités/ressources que l\'utilisateur n\'a pas encore consultées depuis que leur contenu a été modifié';
...
$string['flashbox:edit'] = 'Permission d\'éditer les messages flash';
