...
$string['personalcourselistintoolbar'] = 'Liste personnelle des cours';
$string['personalcourselistintoolbar_desc'] = 'Afficher la liste des cours de l\'utilisateur dans la barre de navigation sous la forme d\'une liste déroulante';
$string['enablenavdrawer'] = 'Activer le "tiroir" de navigation';
$string['enablenavdrawer_desc'] = 'Ajouter un bouton dans la barre de navigation pour afficher/masquer le menu de navigation à gauche de la page';
$string['navbarhomelink'] = 'Raccourci vers la page d\'accueil';
$string['navbarhomelink_desc'] = 'Ajoute un lien vers la page d\'accueil dans la barre de navigation';
$string['navbardashboardlink'] = 'Raccourci vers le tableau de bord';
...
$string['myschoolbag'] = 'Mon cartable';
...
$string['displaymyschoolbagmenu'] = 'Afficher le menu "Mon cartable"';
$string['displaymyschoolbagmenu_desc'] = 'Afficher un menu complémentaire avec accès aux fichiers personnels et aux évaluations';
$string['courseadminmenuintoolbar'] = 'Menu d\'administration du cours';
$string['courseadminmenuintoolbar_desc'] = 'Ajouter le menu d\'administration du cours à la barre de navigation';
$string['adminmenuintoolbar'] = 'Menu d\'administration du site';
$string['adminmenuintoolbar_desc'] = 'Ajouter le menu d\'administration de la plateforme à la barre de navigation';
$string['connectme'] = 'Me connecter';
$string['redballs'] = 'Boules rouges';
$string['enableredballs'] = 'Activer les boules rouges';
