...
$string['hidedefaulteditingbuttondesc'] = 'Masque le bouton d\'édition par défaut (dont la position dépend du contexte. Ce paramètre n\'est pas pris en compte si le précédent est désactivé)';